...
class _$RegisterResponseImpl implements _RegisterResponse {
  ...
  @override
  String toString() {
    return 'RegisterResponse(id: $id, name: $name, email: $email, roles: $roles, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _RegisterResponse implements RegisterResponse {
  const factory _RegisterResponse(
      ...
      required final DateTime updatedAt}) = _$RegisterResponseImpl;
