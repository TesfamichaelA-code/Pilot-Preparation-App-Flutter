...
class _$ExamImpl implements _Exam {
  ...
  @override
  String toString() {
    return 'Exam(title: $title, description: $description, category: $category, difficulty: $difficulty, durationMinutes: $durationMinutes, isActive: $isActive, id: $id, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, title, description, category,
      difficulty, durationMinutes, isActive, id, createdAt, updatedAt, v);
...
abstract class _Exam implements Exam {
  const factory _Exam(
      ...
      @JsonKey(name: '__v') required final int v}) = _$ExamImpl;
