...
class _$ResourceImpl implements _Resource {
  ...
  @override
  String toString() {
    return 'Resource(id: $id, title: $title, description: $description, type: $type, category: $category, author: $author, tags: $tags, externalUrl: $externalUrl, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _Resource implements Resource {
  const factory _Resource(
      ...
      required final DateTime updatedAt}) = _$ResourceImpl;
