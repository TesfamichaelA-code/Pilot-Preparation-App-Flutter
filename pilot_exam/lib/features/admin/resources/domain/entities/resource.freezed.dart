...
class _$ResourceImpl implements _Resource {
  ...
  @override
  String toString() {
    return 'Resource(title: $title, description: $description, type: $type, category: $category, author: $author, tags: $tags, externalUrl: $externalUrl, isActive: $isActive, id: $id, createdAt: $createdAt, updatedAt: $updatedAt, v: $v)';
  }
...
abstract class _Resource implements Resource {
  const factory _Resource(
      ...
      @JsonKey(name: '__v') required final int v}) = _$ResourceImpl;
