...
export class ExamsService {
  ...
  async updateQuestion(
    ...
    // If options and correctAnswer are both provided, validate correctAnswer is in range
    ...
    // If only correctAnswer is provided, ensure it's in range of existing options
